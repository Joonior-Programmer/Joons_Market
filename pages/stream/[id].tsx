    ...
    <Layout canGoBack>
      <div className="py-10 px-4  space-y-4">
        ...
        <div className="border-b">
          ...
          <span className="text-2xl block mt-1 text-gray-900">$140</span>
          <p className=" mt-4 mb-8 text-gray-700">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sint unde,
            ullam quos blanditiis amet ab quisquam aspernatur odio officiis! Id
            expedita dicta autem hic qui facilis illo vel fugiat non.
          </p>
        </div>
