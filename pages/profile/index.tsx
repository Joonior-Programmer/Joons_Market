    ...
    <Layout title="Profile" hasTabBar>
      <div className="py-10 px-4">
        <div className="flex items-center space-x-3">
          <div className="bg-orange-400 w-16 h-16 rounded-full" />
          <div className="flex flex-col">
            <span className="font-medium text-gray-900">Joon</span>
        ...
        <div className="mt-10 flex justify-around">
          ...
          <div className="flex flex-col items-center group cursor-pointer">
            ...
            <span className="text-sm font-medium text-gray-700 mt-2 group-hover:text-lg group-hover:font-bold transition-all">
              구매내역
            </span>
          </div>
          <div className=" flex flex-col items-center group cursor-pointer">
        ...
        <div className="divide-y-[1px] border-t-[1px] mt-4">
          <div className="p-4">
            <div className="flex space-x-4 items-center">
              <div className="bg-purple-300 w-12 h-12 rounded-full" />
              <div>
                <h4 className="ml-1 text-sm font-bold text-gray-900">니꼬</h4>
