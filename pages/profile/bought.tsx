  ...
  return (
    <Layout canGoBack>
      <div className="flex flex-col space-y-5 py-10">
        ...
        <button className="fixed bottom-24 opacity-80 right-5 bg-orange-400 rounded-full p-4 text-white hover:opacity-100 hover:bg-orange-500 hover:font-bold cursor-pointer transition-colors">
          <svg
